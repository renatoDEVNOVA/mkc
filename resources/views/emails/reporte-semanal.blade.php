...
<body>
    ...
    <p>Se le envia el reporte que corresponde a la semana del {{date('d-m-Y', strtotime($fechaInicio))}} al {{date('d-m-Y', strtotime($fechaFin))}}. Cualquier duda o comentario, será bien recibido. Muchas gracias.</p>
    <br>
