...
<body>
    ...
    <p>Se le envia el reporte del {{date('d-m-Y', strtotime($fechaInicio))}} al {{date('d-m-Y', strtotime($fechaFin))}}. Cualquier duda o comentario, será bien recibido. Muchas gracias.</p>
    <br>
