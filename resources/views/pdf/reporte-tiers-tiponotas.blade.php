                ...
                <table class="statistics-table">
                    <thead>
                        <tr>
                            ...
                            @case(2)
                                ...
                                @break
                            @case(3)
                                <th style="text-align: center;">Reseña</th>
                                @break
                            @case(4)
                                <th style="text-align: center;">Opinión</th>
                                @break
                            @default
                    ...
                    @foreach($tipoTiersTotales as $tipoTierTotal)
                        <tr>
                            ...
                            @endswitch
                            @foreach($tipoNotasTotales as $tipoNotaTotal)
                            <td style="text-align: center;">{{($count[$tipoTierTotal][$tipoNotaTotal] > 0) ? $count[$tipoTierTotal][$tipoNotaTotal] : '-'}}</td>
                            @endforeach
                    ...
                    @endforeach
                        <tr>
                            ...
                            @foreach($tipoNotasTotales as $tipoNotaTotal)
                            <td style="text-align: center; font-weight: bold;">{{($count['total'][$tipoNotaTotal] > 0) ? $count['total'][$tipoNotaTotal] : '-'}}</td>
                            @endforeach
        ...
        <section class="second-page">
            <div class="container-table">
                ...
                <table>
                    ...
                    <tbody>
                    @foreach($dataTipoTierTipoNota as $item)
                        @if ($tipoNota === $item->tipoNota)
                        <tr>
                            <td style="width: 50%;">
                                ...
                                @switch($item->tipoNota)
                                    @case(1)
                                        <div style="color: #FFFFFF; text-transform: uppercase; font-size: 10px; font-weight: bold; background-color: #02704B; margin: 10px 0px; height: 20px; line-height: 10px; width: 80px; text-align: center; border-radius: 2px;">Nota</div>
                                        @break
                                    @case(2)
                                        <div style="color: #FFFFFF; text-transform: uppercase; font-size: 10px; font-weight: bold; background-color: #FE6D34; margin: 10px 0px; height: 20px; line-height: 10px; width: 80px; text-align: center; border-radius: 2px;">Entrevista</div>
                                        @break
                                    @case(3)
                                        <div style="color: #FFFFFF; text-transform: uppercase; font-size: 10px; font-weight: bold; background-color: #FFD731; margin: 10px 0px; height: 20px; line-height: 10px; width: 80px; text-align: center; border-radius: 2px;">Reseña</div>
                                        @break
                                    @case(4)
                                        <div style="color: #FFFFFF; text-transform: uppercase; font-size: 10px; font-weight: bold; background-color: #1A1AB5; margin: 10px 0px; height: 20px; line-height: 10px; width: 80px; text-align: center; border-radius: 2px;">Opinión</div>
                                        @break
                                    @default
                                ...
                                @endswitch
                                    ...
                                    @endif
                                    @if (!empty($item->Plataforma))
                                    <li><strong>PLATAFORMA:</strong> {{$item->Plataforma}}</li>
                                    @endif
