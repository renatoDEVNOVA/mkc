                ...
                <table class="statistics-table">
                    ...
                    @foreach($vocerosTotales as $voceroTotal)
                        <tr>
                            ...
                            @foreach($tipoNotas as $tipoNota)
                            <td style="text-align: center;">{{($count[$voceroTotal->id][$tipoNota] > 0) ? $count[$voceroTotal->id][$tipoNota] : '-'}}</td>
                            @endforeach
        ...
        <section class="second-page">
            ...
            @foreach($voceros as $vocero)
                ...
                <table>
                    ...
                    <tbody>
                    @foreach($tipoNotas as $tipoNota)
                    @if ($count[$vocero->id][$tipoNota] > 0)
                        @foreach($data as $item)
                        @if ($vocero->id === $item->idVocero  && $tipoNota === $item->tipoNota)
                        <tr>
                            <td style="width: 50%;">
