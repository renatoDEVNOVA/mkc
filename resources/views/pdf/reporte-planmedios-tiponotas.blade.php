                ...
                <table class="statistics-table">
                    ...
                    @foreach($planMediosTotales as $planMedioTotal)
                        <tr>
                            ...
                            @foreach($tipoNotas as $tipoNota)
                            <td style="text-align: center;">{{($count[$planMedioTotal->id][$tipoNota] > 0) ? $count[$planMedioTotal->id][$tipoNota] : '-'}}</td>
                            @endforeach
                    ...
                    @endforeach
                        <tr>
                            ...
                            @foreach($tipoNotas as $tipoNota)
                            <td style="text-align: center; font-weight: bold;">{{($count['total'][$tipoNota] > 0) ? $count['total'][$tipoNota] : '-'}}</td>
                            @endforeach
        ...
        <section class="second-page">
            ...
            @foreach($planMedios as $planMedio)
                ...
                <table>
                    ...
                    <tbody>
                    @foreach($tipoNotas as $tipoNota)
                    @if ($count[$planMedio->id][$tipoNota] > 0)
                        @foreach($data as $item)
                        @if ($planMedio->id === $item->idPlanMedio  && $tipoNota === $item->tipoNota)
                        <tr>
                            <td style="width: 50%;">
