                ...
                <table class="statistics-table">
                    ...
                    @foreach($campanasTotales as $campanaTotal)
                        <tr>
                            ...
                            @foreach($tipoNotas as $tipoNota)
                            <td style="text-align: center;">{{($count[$campanaTotal->id][$tipoNota] > 0) ? $count[$campanaTotal->id][$tipoNota] : '-'}}</td>
                            @endforeach
        ...
        <section class="second-page">
            ...
            @foreach($campanas as $campana)
                ...
                <table>
                    ...
                    <tbody>
                    @foreach($tipoNotas as $tipoNota)
                    @if ($count[$campana->id][$tipoNota] > 0)
                        @foreach($data as $item)
                        @if ($campana->id === $item->idCampaign  && $tipoNota === $item->tipoNota)
                        <tr>
                            <td style="width: 50%;">
