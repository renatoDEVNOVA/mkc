...
<head>
    ...
    <title>REPORTE DETALLADO POR TIERS</title>
    <style>
...
<body>
    ...
    <header>
        <div class="header_adp">
            <div class="title">
                <p style="color: #FF3333;"><strong>REPORTE DETALLADO POR TIERS</strong></p>
            </div>
            <div class="logo">
    ...
    @if (!$lastPage) 
        ...
        <section class="first-page">
            <div class="container-table">
                ...
                <p><strong>Publicaciones por tiers:</strong></p>
            </div>
            @if ($isVal || $isDet)
            <div class="container-table">
                ...
                <table class="statistics-table">
                    ...
                    @foreach($tipoTiersTotales as $tipoTierTotal)
                        <tr>
                            ...
                            @endswitch
                            @foreach($plataformasTotales as $plataformaTotal)
                            <td style="text-align: center;">{{($count[$tipoTierTotal][$plataformaTotal->id] > 0) ? $count[$tipoTierTotal][$plataformaTotal->id] : '-'}}</td>
                            @endforeach
                            <td style="text-align: center; font-weight: bold;">{{($count[$tipoTierTotal]['total'] > 0) ? $count[$tipoTierTotal]['total'] : '-'}}</td>
                        </tr>
                    @endforeach
                        <tr>
                ...
                <table>
                    <thead>
                        <tr>
                             @switch($tipoTier)
                                @case(1)
                                    <th style="text-align: left; text-transform: uppercase; font-weight: bold;" colspan="2">Tier 1</th>
                                    @break
                                @case(2)
                                    <th style="text-align: left; text-transform: uppercase; font-weight: bold;" colspan="2">Tier 2</th>
                                    @break
                                @case(3)
                                    <th style="text-align: left; text-transform: uppercase; font-weight: bold;" colspan="2">Tier 3</th>
                                    @break
                                @default
                    ...
                    <tbody>
                    @foreach($dataTipoTierPlat as $item)
    ...
    @if ($lastPage) 
        <section class="third-page">
            ...
            @else
                <img src="../storage/app/clientes/logo.png" width="100" alt="">
            @endif
                <p>REPORTE DETALLADO POR TIERS</p>
            </div>
        </section>
    @endif    
    </main>
