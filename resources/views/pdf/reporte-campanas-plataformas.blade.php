        ...
        <section class="first-page">
            ...
            <div class="container-table">
                <table class="statistics-table">
                    ...
                    <tbody>
                    @foreach($campanasTotales as $campanaTotal)
                        <tr>
                            <td style="text-align: left;">{{$campanaTotal->titulo}}</td>
                            @foreach($plataformas as $plataforma)
                            <td style="text-align: center;">{{($count[$campanaTotal->id][$plataforma->id] > 0) ? $count[$campanaTotal->id][$plataforma->id] : '-'}}</td>
                            @endforeach
                            <td style="text-align: center; font-weight: bold;">{{($count[$campanaTotal->id]['total'] > 0) ? $count[$campanaTotal->id]['total'] : '-'}}</td>
                        </tr>
                    @endforeach
                        <tr>
        ...
        <section class="second-page">
            ...
            @foreach($campanas as $campana)
                ...
                <table>
                    <thead>
                        <tr>
                            <th style="text-align: left; text-transform: uppercase; font-weight: bold;" colspan="2">{{$campana->titulo}}</th>
                        </tr>
                    </thead>
                    <tbody>
                    @foreach($plataformas as $plataforma)
                    @if ($count[$campana->id][$plataforma->id] > 0)
                        @foreach($data as $item)
                        @if ($campana->id === $item->idCampaign  && $plataforma->id === $item->idPlataforma)
                        <tr>
                            <td style="width: 50%;">
