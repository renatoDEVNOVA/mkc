                ...
                <table class="statistics-table">
                    ...
                    @foreach($vocerosTotales as $voceroTotal)
                        <tr>
                            ...
                            @foreach($tipoTiers as $tipoTier)
                            <td style="text-align: center;">{{($count[$voceroTotal->id][$tipoTier] > 0) ? $count[$voceroTotal->id][$tipoTier] : '-'}}</td>
                            @endforeach
        ...
        <section class="second-page">
            ...
            @foreach($voceros as $vocero)
                ...
                <table>
                    ...
                    <tbody>
                    @foreach($tipoTiers as $tipoTier)
                    @if ($count[$vocero->id][$tipoTier] > 0)
                        @foreach($data as $item)
                        @if ($vocero->id === $item->idVocero  && $tipoTier === $item->tipoTier)
                        <tr>
                            <td style="width: 50%;">
