                ...
                <table class="statistics-table">
                    ...
                    @foreach($campanasTotales as $campanaTotal)
                        <tr>
                            ...
                            @foreach($tipoTiers as $tipoTier)
                            <td style="text-align: center;">{{($count[$campanaTotal->id][$tipoTier] > 0) ? $count[$campanaTotal->id][$tipoTier] : '-'}}</td>
                            @endforeach
        ...
        <section class="second-page">
            ...
            @foreach($campanas as $campana)
                ...
                <table>
                    ...
                    <tbody>
                    @foreach($tipoTiers as $tipoTier)
                    @if ($count[$campana->id][$tipoTier] > 0)
                        @foreach($data as $item)
                        @if ($campana->id === $item->idCampaign  && $tipoTier === $item->tipoTier)
                        <tr>
                            <td style="width: 50%;">
