                ...
                <table class="statistics-table">
                    ...
                    @foreach($planMediosTotales as $planMedioTotal)
                        <tr>
                            ...
                            @foreach($tipoTiers as $tipoTier)
                            <td style="text-align: center;">{{($count[$planMedioTotal->id][$tipoTier] > 0) ? $count[$planMedioTotal->id][$tipoTier] : '-'}}</td>
                            @endforeach
                    ...
                    @endforeach
                        <tr>
                            ...
                            @foreach($tipoTiers as $tipoTier)
                            <td style="text-align: center; font-weight: bold;">{{($count['total'][$tipoTier] > 0) ? $count['total'][$tipoTier] : '-'}}</td>
                            @endforeach
        ...
        <section class="second-page">
            ...
            @foreach($planMedios as $planMedio)
                ...
                <table>
                    ...
                    <tbody>
                    @foreach($tipoTiers as $tipoTier)
                    @if ($count[$planMedio->id][$tipoTier] > 0)
                        @foreach($data as $item)
                        @if ($planMedio->id === $item->idPlanMedio  && $tipoTier === $item->tipoTier)
                        <tr>
                            <td style="width: 50%;">
