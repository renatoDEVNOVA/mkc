                ...
                <table class="statistics-table">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center;">Publicaciones</th>
                        </tr>
                    </thead>
                    <tbody>
                    @foreach($plataformasTotales as $plataformaTotal)
                        <tr>
                            ...
                            <td style="text-align: center;">{{($count[$plataformaTotal->id] > 0) ? $count[$plataformaTotal->id] : '-'}}</td>
                        </tr>
                    @endforeach
                        <tr>
                            <td style="text-align: center; font-weight: bold;">TOTAL</td>
                            <td style="text-align: center; font-weight: bold;">{{$count['total']}}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
