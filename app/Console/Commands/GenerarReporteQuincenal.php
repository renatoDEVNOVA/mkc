...
use Mail;
use App\Mail\ReporteQuincenal as ReporteQuincenalMail;

class GenerarReporteQuincenal extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'generate:reporte_quincenal';
     ...
     * @var string
     */
    protected $description = 'Genera los reportes quincenales';
    ...
    public function handle()
    {
        ...
        foreach ($clientes as $cliente) {
            # code...
            $clienteEnvio = $cliente->envios()->where('tipoPeriodo', 3)->first();
                        ...
                        if ($validatorEmail->fails()) {
                            ...
                            if (in_array(1, $tiposReporte)) {
                                ...
                                if(!$emptyData[1]){
                                    ...
                                    $tituloCorreo = "REPORTE QUINCENAL POR PLATAFORMAS";
                                    $asunto = strtoupper($cliente->nombreComercial).": REPORTE QUINCENAL POR PLATAFORMAS - ".$Mes;
                                    $fileName = $filesName[1];
        
                                    try {
        
                                        Mail::to($destinatario->email, $destinatario->name)
                                        ->send(new ReporteQuincenalMail($tituloCorreo, $destinatario, $fileName, $Mes, $fechaInicio, $fechaFin, $asunto));
                            ...
                            if (in_array(2, $tiposReporte)) {
                                ...
                                if(!$emptyData[2]){
                                    ...
                                    $tituloCorreo = "REPORTE QUINCENAL POR CAMPAÑAS";
                                    $asunto = strtoupper($cliente->nombreComercial).": REPORTE QUINCENAL POR CAMPAÑAS - ".$Mes;
                            ...
                            if (in_array(3, $tiposReporte)) {
                                ...
                                if(!$emptyData[3]){
                                    ...
                                    $tituloCorreo = "REPORTE QUINCENAL POR VOCEROS";
                                    $asunto = strtoupper($cliente->nombreComercial).": REPORTE QUINCENAL POR VOCEROS - ".$Mes;
